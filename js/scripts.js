$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            end: new Date('Jul 22, 2019 00:00'),

            // Event Address
            address: 'Россия, Новосибирская область, Садовый, ул. Березовая 14/7',

            // Event Description
            description: "Мы ждем Вас в этот знаменательный день. По всем вопросам звоните: 89133791299 (Ирина)"
        }
    });
